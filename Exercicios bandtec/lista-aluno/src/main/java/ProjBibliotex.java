...
public class ProjBibliotex {
    public static void gravaLista(ListaObj<Livros> lista, boolean isCSV) {
        ...
        if (isCSV) {
            nomeArquivo= "livros.csv";	// nome do arquivo, se for CSV
        }
        else {
            nomeArquivo= "livros.txt";	// nome do arquivo, se for TXT
        }
        ...
        try {
            ...
            for (int i=0; i< lista.getTamanho(); i++) {
                ...
                if (isCSV) {
                    saida.format("%s;%s;%s;%s;%d;%s%n",livros.getTitulo(),
                            livros.getIsbn(),livros.getEdicao(), livros.getAno(), livros.getPaginas(),livros.getEditora());	// separados por ';'
                }
                else {
                    saida.format("%s;%s;%s;%s;%d;%s%n",livros.getTitulo(),
                    livros.getIsbn(),livros.getEdicao(), livros.getAno(), livros.getPaginas(),livros.getEditora());// separados por ' '
    ...
    public static void leExibeArquivo(boolean isCSV) {
        ...
        try {
            ...
            System.out.printf("%-8s%-10s%7s%7s%17s%15s\n","Título","ISBN","Edição", "Ano","Páginas", "Editora" );
            ...
            while (entrada.hasNext()) {
                ...
                System.out.printf("%7s %-10s %7s %7s %10d %7s", titulo, isbn, edicao,ano,paginas,editora);
            }
        }
    ...
    public static void main(String[] args) {
        ...
        ListaObj<Livros> lista = new ListaObj(5);
        ...
        while (!fim) {	// Fica num loop até que o usuário escolha Fim
            ...
            switch(opcao) {
                ...
                case 1:
                    ...
                    Livros livro = new Livros(titulo,isbn,edicao,ano,paginas,editora);
